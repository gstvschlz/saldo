...
class RepositorioFixo(input: LedgerInput, tags: List<Tag> = emptyList()) : SaldoRepository {
    ...
    override suspend fun editar(mov: Movimentacao, escopo: EscopoEdicao, diaDoMes: Int?) = Unit
    ...
    override suspend fun encerrarRecorrencia(mov: Movimentacao, mesDaSerie: YearMonth) = Unit
